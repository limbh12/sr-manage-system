...
CREATE TABLE IF NOT EXISTS wiki_file (
    ...
    type VARCHAR(20) NOT NULL CHECK (type IN ('IMAGE', 'DOCUMENT', 'ATTACHMENT')),
...
-- WHERE TABLE_NAME IN ('WIKI_CATEGORY', 'WIKI_DOCUMENT', 'WIKI_VERSION', 'WIKI_FILE', 'SR_WIKI_DOCUMENT');
